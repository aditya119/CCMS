...
CREATE TABLE platforms (
    platform_id     NUMBER(10)
        GENERATED BY DEFAULT AS IDENTITY ( START WITH 10000 INCREMENT BY 1 ),
    platform_name   VARCHAR2(1000) NOT NULL,
    date_created    DATE DEFAULT SYSDATE,
    deleted         DATE DEFAULT NULL,
...
CREATE TABLE user_sessions (
    ...
    guid              VARCHAR2(1000) DEFAULT NULL,
...
CREATE TABLE lawyers (
    ...
    lawyer_email      VARCHAR2(1000) NOT NULL,
...
CREATE TABLE proceeding_decisions (
    proceeding_decision_id     NUMBER(10)
        GENERATED BY DEFAULT AS IDENTITY ( START WITH 10000 INCREMENT BY 1 ),
    proceeding_decision_name   VARCHAR2(1000),
