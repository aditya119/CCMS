...
CREATE TABLE user_sessions (
    ...
    web_guid          VARCHAR2(100) DEFAULT 0,
    mobile_guid       VARCHAR2(100) DEFAULT 0,
    desktop_guid      VARCHAR2(100) DEFAULT 0,
    CONSTRAINT user_sessions_pk PRIMARY KEY ( user_session_id ),
    CONSTRAINT fk_session_user FOREIGN KEY ( user_id )
        REFERENCES app_users ( user_id ),
    CONSTRAINT unique_session_user UNIQUE ( user_id ),
    CONSTRAINT unique_web_guid UNIQUE ( web_guid ),
    CONSTRAINT unique_mobile_guid UNIQUE ( mobile_guid ),
    CONSTRAINT unique_desktop_guid UNIQUE ( desktop_guid )
);
